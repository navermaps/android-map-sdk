...
class OverlayCollisionActivity : ToolbarActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(naverMap: NaverMap) {
        ...
        val bottom = findViewById<CheckedTextView>(R.id.bottom)
        val edges = findViewById<CheckedTextView>(R.id.edges)
        val apexes = findViewById<CheckedTextView>(R.id.apexes)
        val outsides = findViewById<CheckedTextView>(R.id.outsides)
        ...
        val onCaptionAlignsClickListener = View.OnClickListener {
            bottom.isChecked = bottom == it
            edges.isChecked = edges == it
            apexes.isChecked = apexes == it
            outsides.isChecked = outsides == it
            @Suppress("UNCHECKED_CAST")
            val aligns = it.tag as Array<Align>
