...
import kotlinx.android.synthetic.main.activity_projection.*
...
class ProjectionActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(naverMap: NaverMap) {
        ...
        naverMap.addOnCameraChangeListener { _, _ ->
            ...
            marker.captionText = getString(R.string.format_point_coord,
    ...
    private fun updateCrosshairCoord() {
        if (crosshairPoint.x.isNaN() || crosshairPoint.y.isNaN()) {
            return
        }
        map?.let {
            val coord = it.projection.fromScreenLocation(crosshairPoint)
            text.text = getString(R.string.format_point_coord,
