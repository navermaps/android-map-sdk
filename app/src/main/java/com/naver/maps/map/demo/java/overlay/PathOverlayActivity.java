/*
 * Copyright 2018-2026 NAVER Corp.
 *
...
public class PathOverlayActivity extends ToolbarActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        pathOverlay.setCoords(COORDS_1);
        pathOverlay.setWidth(width);
        pathOverlay.setOutlineWidth(outlineWidth);
        ...
        pathOverlay.setPassedColor(ResourcesCompat.getColor(getResources(), R.color.gray, getTheme()));
        pathOverlay.setPassedOutlineColor(Color.WHITE);
        pathOverlay.setProgress(0.3);
        pathOverlay.setMap(naverMap);

        PathOverlay pathOverlayWithPattern = new PathOverlay();
        pathOverlayWithPattern.setCoords(COORDS_2);
        pathOverlayWithPattern.setWidth(width);
        pathOverlayWithPattern.setOutlineWidth(0);
        pathOverlayWithPattern.setColor(Color.BLUE);
        pathOverlayWithPattern.setPatternImage(OverlayImage.fromResource(R.drawable.path_pattern));
        pathOverlayWithPattern.setPatternInterval(
            getResources().getDimensionPixelSize(R.dimen.overlay_pattern_interval));
        pathOverlayWithPattern.setMap(naverMap);
