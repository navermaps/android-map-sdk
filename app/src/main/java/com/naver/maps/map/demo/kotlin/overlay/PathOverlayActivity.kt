...
import kotlinx.android.synthetic.main.activity_path_overlay.*

class PathOverlayActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(naverMap: NaverMap) {
        ...
        naverMap.setOnMapClickListener { _, coord ->
            val progress = GeometryUtils.getProgress(pathOverlay.coords, coord)
            pathOverlay.progress = progress
